...
@sython.on(events.NewMessage(outgoing=False, pattern='شخرميت'))
async def OwnerStart(event):
    sender = await event.get_sender()
    if sender.id == ownerhson_id :
        order = await event.reply('هنا يمك شخرميت ابشر  @Z6Z4Z')
...
async def _(event):
      await event.reply("""السـورس يعمـل |شخرميت
╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍
...
async def _(event):
      await event.reply("""شخرميت : @Z6Z4Z"""
)
